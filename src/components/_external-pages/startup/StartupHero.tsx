...
//
import { varFadeIn, varFadeInRight, varFadeInUp, varWrapEnter, MotionInView } from '../../animate';
import { ContentStyle, HeroImgStyle, HeroOverlayStyle, RootStyle } from './Startup.styles';
